...
<head runat="server">
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
         ...
         function ReloadParent(r1,r2,r3,r4) {

             if (window.opener != null && !window.opener.closed) {

                 window.opener.location.href = 'Default.aspx?group=' + r1 + '&ShowRow=' + r2 + '&FatchSAP=' + r3 + '&Fatch=' + r4
...
<asp:ListItem Value="HD">HES-DELTA</asp:ListItem>
            ...
            <tr>
                <td>Amount Row/Page (default : 15 row)</td>
                <td>
